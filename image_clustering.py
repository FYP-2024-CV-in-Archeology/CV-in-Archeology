...
class image_clustering:
	...
	def __init__(self, folder_path="data", n_clusters=10, max_examples=None, use_imagenets=False, use_pca=False):
		...
		del paths 
		try:
			shutil.rmtree("C:/Users/29736/Desktop/image-clustering-master/output")
	...
	def load_images(self):
		...
		self.images = np.float32(self.images).reshape(-1 , 224, 224, 3)
		self.images /= 255
...
if __name__ == "__main__":
	...
	number_of_clusters = 15 # cluster names will be 0 to number_of_clusters-1

	data_path = "C:/Users/29736/Desktop/image-clustering-master/data" # path of the folder that contains the images to be considered for the clustering (The folder must contain only image files)
